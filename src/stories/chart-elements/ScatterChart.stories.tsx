...
export const CustomTooltip: Story = {
  args: {
    ...
    customTooltip: (props: CustomTooltipType) => {
      ...
      return (
        <div className="w-48 rounded-garmz-default text-garmz-default bg-garmz-background p-2 shadow-garmz-dropdown border border-garmz-border">
          <div className="flex flex-1 space-x-2.5">
            <div className={`w-1.5 flex flex-col bg-${payload?.[0]?.color}-500 rounded`} />
            <div className="w-full">
              <p className="mb-2 font-medium text-garmz-content-emphasis">{label}</p>
